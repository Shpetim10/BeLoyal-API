...
@Service("manualCodeLookup")
@RequiredArgsConstructor
public class CustomerProfileLookupByManualCodeService implements CustomerProfileLookupService {
    private final LoyaltyCardRepository loyaltyCardRepository;

    @Override
    public CustomerProfile search(String query) {
        Optional<LoyaltyCard> loyaltyCard= loyaltyCardRepository.getLoyaltyCardByManualCode(query.toUpperCase());
