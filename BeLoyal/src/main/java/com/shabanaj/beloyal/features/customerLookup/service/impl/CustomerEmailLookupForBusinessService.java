...
@Service("emailLookupForBusiness")
public class CustomerEmailLookupForBusinessService implements CustomerLookupForBusinessService {
    ...
    public CustomerEmailLookupForBusinessService(@Qualifier("emailLookup") CustomerProfileLookupService customerProfileLookupService, BusinessService businessService, LoyaltyAccountService loyaltyAccountService) {
