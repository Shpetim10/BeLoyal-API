...
@Service("qrTokenLookupForBusiness")
public class CustomerQrTokenLookupForBusinessService implements CustomerLookupForBusinessService {
    ...
    public CustomerQrTokenLookupForBusinessService(@Qualifier("qrTokenLookup") CustomerProfileLookupService customerProfileLookupService, BusinessService businessService, LoyaltyAccountService loyaltyAccountService) {
